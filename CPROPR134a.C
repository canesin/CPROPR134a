...
namespace Foam
{
    defineTypeNameAndDebug(CPROPR134a, 0);
    addToRunTimeSelectionTable(liquidProperties, CPROPR134a,);
    addToRunTimeSelectionTable(liquidProperties, CPROPR134a, Istream);
    addToRunTimeSelectionTable(liquidProperties, CPROPR134a, dictionary);
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::CPROPR134a::CPROPR134a()
:
    liquidProperties
    (
        106.167,
...
Foam::CPROPR134a::CPROPR134a(Istream& is)
:
    liquidProperties(is),
    rho_(is),
    pv_(is),
...
Foam::CPROPR134a::CPROPR134a(const dictionary& dict)
:
...
Foam::CPROPR134a::CPROPR134a(const CPROPR134a& liq)
:
